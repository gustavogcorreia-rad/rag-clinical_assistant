...
st.markdown(f"**Tipo de hemorragia detectada:** Epidural")
...
def processar_dados(dados_clinicos):
    """
    Chama o pipeline do agente, passando o dicionário dados_clinicos.
    """
    # Chamada real para o agent.py
    resposta, referencias = processar(dados_clinicos)
    st.success("Sugestão clínica baseada em evidência:")
    st.markdown(resposta)
    st.markdown(referencias)
    # Opcional: mostrar os dados enviados
